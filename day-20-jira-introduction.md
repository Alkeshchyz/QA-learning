...
**Next Practical Task:** Create a Jira account and a QA Learning project.
...
```bash
git add 03-practical-manual-testing/notes/day-20-jira-introduction.md
git commit -m "Add Day 20 Jira introduction and bug tracking notes"
